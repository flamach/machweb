(() => {
  const fr = {
    ...
    'hero.scene1.sub': 'Révélez le potentiel de votre marque<br>grâce à une stratégie sur mesure,<br>une créativité audacieuse<br>et un storytelling inoubliable.',
    'hero.scene2.title': "l'excellence<br>par le design",
    'hero.scene2.sub': 'Nous façonnons des identités de marque singulières<br>et mémorables pour vous démarquer<br>et sublimer votre présence sur le marché.',
